...
export const ImageWelcome = ({ theme }: { theme?: "light" | "dark" }) => {
  return (
    <Html>
      <Tailwind theme={theme}>
        ...
        <Body>
          <Container
            align="center"
            className="w-full max-w-160 bg-secondary md:p-8"
          >
            <Header />
            <Container align="left" className="max-w-full bg-primary px-6 py-8">
              ...
              <Row className="mb-12">
                <Text className="text-md text-tertiary md:text-lg">
                  ...
                  <br />
                  <br />
                  Whether you're here for your brand, for a cause, or just for
                  fun—welcome! If there's anything you need, we'll be here every
                  step of the way.
                  <br />
                  <br />
                  Thanks,
