    ...
    <section className="bg-brand-section py-16 md:py-24">
      <div className="mx-auto max-w-container px-4 md:px-8">
        ...
        <div className="mx-auto mt-12 max-w-3xl md:mt-16">
          <div className="flex flex-col gap-8">
            {faqsExtended.map((faq, index) => (
              <div
                key={faq.question}
                className="not-first:-mt-px not-first:border-t not-first:border-brand_alt not-first:pt-6"
              >
                <h3>
                  <button
                  ...
                  >
                    <span className="text-md font-semibold text-primary_on-brand">
                      {faq.question}
                    </span>

                    <span
                      aria-hidden="true"
                      className="flex size-6 items-center text-icon-fg-brand_on-brand"
                    >
                      <svg
                        width="24"
                        height="24"
        ...
        <div className="mt-12 flex flex-col items-center gap-6 rounded-2xl bg-brand-section_subtle px-6 py-8 text-center md:mt-16 md:gap-8 md:pt-8 md:pb-10">
          ...
          <div>
            <h4 className="text-xl font-semibold text-primary_on-brand">
